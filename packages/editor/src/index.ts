...
// #1758 — audio objects in a throwaway frame, freed when it is disposed.
export { openAudioFrame, withAudioFrame, canOpenAudioFrame, offlineContextInFrame, bridgeAudioExtensions } from './engine/audioFrame'
export type { AudioFrame } from './engine/audioFrame'
