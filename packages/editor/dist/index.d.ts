 ...
 */
declare const ALIAS_MAP: Record<string, string | string[]>;
...
declare function getSignalAliases(): SignalAliasMap;
 ...
 *  storage either. */
declare function setSignalAliases(map: SignalAliasMap): void;
