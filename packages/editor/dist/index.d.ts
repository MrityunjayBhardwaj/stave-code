 ...
 */
declare function retryDocSave(): Promise<boolean>;
/**
...
declare function getStorageStatus(): StorageStatus;
/** Called on every change. Returns the unsubscribe. */
declare function subscribeStorageStatus(fn: () => void): () => void;
 ...
 */
declare function unregisterAsset(name: string): void;
/**
 ...
 * memory names.
 */
declare function holdTabPresence(): Promise<boolean>;
/**
 ...
 */
declare function withSoundRefsLock<T>(fn: () => Promise<T>): Promise<T>;
 ...
 */
declare function collectUnusedSounds(deps?: CollectDeps): Promise<CollectResult>;
