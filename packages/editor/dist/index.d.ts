...
declare function setSoundCatalogAccessor(fn: CatalogAccessor | null): void;
/** App calls this when the soundMap changes (samples finished loading). */
declare function notifySoundCatalogChanged(): void;
