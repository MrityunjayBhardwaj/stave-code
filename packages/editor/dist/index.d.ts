...
declare function canOpenAudioFrame(doc?: Document | undefined): boolean;
/**
 ...
 */
declare function bridgeAudioExtensions(page: object, frame: object): number;
/**
...
type TrackDisplay = 'waveform' | 'bars';
 ...
 */
declare class StorageFullError extends Error {
    readonly cause: unknown;
    constructor(cause: unknown);
}
/** Whether an error is the browser saying it has no room. */
declare function isQuotaError(err: unknown): boolean;
 ...
 */
declare function sampleRefOf(ev: Pick<IREvent, 's' | 'n' | 'note' | 'freq' | 'params'>): SampleRef | null;
 ...
 */
declare function playedSoundName(s: string, deps?: SamplePeaksDeps): string;
/**
