...
declare function getEditorBreadcrumbs(): boolean;
declare function setEditorBreadcrumbs(on: boolean): void;
declare function toggleEditorBreadcrumbs(): void;
declare function onBreadcrumbsChange(cb: (on: boolean) => void): () => void;
