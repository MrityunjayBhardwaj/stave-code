...
type TimeStep = SectionWindow | TimeWarp;
 ...
 */
type UnboundedSignalKind = Extract<SignalKind, 'time' | 'cyclesPer' | 'per' | 'perCycle' | 'perx'>;
 ...
 */
declare function signalTimeAt(a: SignalAutomation, time: number): number | null;
/**
 ...
 */
declare function shapeAlternatives(kind: SignalKind): readonly SignalKind[];
/**
 ...
 */
declare function previewRepeat(analysis: SongAnalysis, laneKey: string, paramPeriods: readonly number[], cap?: number): number | null;
 ...
 */
declare function previewShapeSwap(ir: PatternIR | null, a: SignalAutomation, next: SignalKind, opts: Pick<AnalyzeSongOptions, 'collectFn' | 'hasUnheardTrack' | 'signal' | 'yieldFn'>): Promise<SongAnalysis | null>;
/**
 ...
 */
declare function signalDimensionsOf(ir: PatternIR | null | undefined, swap?: ShapeSwap): SignalDimensions;
/**
 ...
 */
declare function songPeriodOf(a: {
    readonly periodCycles: number;
    readonly placements: readonly (readonly TimeStep[])[];
}): number | null;
/**
 ...
 */
declare function analyzeEvents(events: readonly IREvent[], horizon: number, reachedCap?: boolean, detectPeriodFn?: (events: readonly IREvent[], horizon: number) => number | null, capCycles?: number, steppedKeys?: ReadonlyMap<string, ReadonlySet<string>>): SongAnalysis;
 ...
 */
declare function steppedAutomations(ir: PatternIR | null | undefined): readonly SteppedAutomation[];
/**
 ...
 */
declare function stepIndexAtCycle(a: SteppedAutomation, cycle: number): number | null;
/**
...
declare function fixedParameters(ir: PatternIR | null | undefined): readonly FixedParameter[];
/**
 ...
 */
declare function fixedToStepsEdit(f: FixedParameter, steps: number, source: string): {
    range: [number, number];
    text: string;
} | null;
 ...
 */
declare function stepCountEdit(a: SteppedAutomation, n: number, source: string): StepCountEdit | null;
...
interface NamedStage {
    readonly name: string;
    readonly ir: PatternIR;
}
declare function parseStrudelStages(code: string): NamedStage[];
...
declare function describeSkipped(skipped: SkippedSounds[]): string;
...
interface TrackEnvelopeView extends TrackEnvelope {
    /** The track plays something else now than when this was rendered. */
    readonly stale: boolean;
}
interface TrackEnvelopeStatus {
...
declare class StrudelEngine implements LiveCodingEngine {
     ...
     */
    renderLoadedStemsReport(duration: number, sampleRate?: number, signal?: AbortSignal, onProgress?: (renderedSeconds: number, totalSeconds: number) => void): Promise<{
        order: string[];
        stems: Record<string, StemOutcome<{
            blob: Blob;
            haps: number;
            played: number;
            skipped: SkippedSounds[];
...
declare const SONG_LEVEL_STEM = "(song)";

/** What a song-level stem (sound `all(...)` adds that no track owns) is called. */
declare const SONG_LEVEL_STEM_NAME = "song-level";
 ...
 */
declare function resolveSampleUrl(ref: SampleRef, deps?: SamplePeaksDeps): string | null;
/**
...
declare class LiveCodingRuntime implements LiveCodingRuntime$1 {
     ...
     */
    bounceStemsOffline(seconds: number, signal?: AbortSignal, 
    /** Seconds rendered across the whole set, out of `totalSeconds`. */
    onProgress?: (renderedSeconds: number, totalSeconds: number) => void): Promise<{
        stems: BouncedStem[];
    } | null>;
    /**
 ...
 * mixer already uses.
 */
declare function hasKnownKnobRange(method: string): boolean;
/**
