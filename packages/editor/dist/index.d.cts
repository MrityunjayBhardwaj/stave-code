 ...
 */
declare function aggregateLaneItems(items: readonly LaneItem[], nCycles: number): LaneSkeleton[];
/**
 ...
 */
declare function structuralWalk(ir: PatternIR, nCycles: number): LaneSkeleton[];
