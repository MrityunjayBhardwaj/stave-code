...
function HistoryPanel() {
  ...
  const [expanded, setExpanded] = React6__namespace.useState(null);
  const [hovered, setHovered] = React6__namespace.useState(null);
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { flex: 1, minWidth: 0, paddingBottom: 8 }, children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: 2, marginTop: 2, marginLeft: 14, opacity: isHovered || isOpen ? 1 : 0.18, transition: "opacity 120ms" }, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("button", { title: "View (read-only time-travel)", style: iconBtn(), onClick: () => {
                  setDiffing(null);
                  setViewingCommit(c);
                }, "data-history-view": c.id, children: /* @__PURE__ */ jsxRuntime.jsx(IconView, {}) })
              ] }),
