        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0, paddingBottom: 8 }, children: [
              ...
              forkCounts.has(c.id) && /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 4, marginTop: 3, marginLeft: 20 }, children: branches.filter((b) => b.createdFrom === c.id).map((b) => /* @__PURE__ */ jsxs("span", { "data-history-branch-chip": b.name, style: { fontSize: 9, color: accent3, border: `1px solid ${accent3}`, borderRadius: 8, padding: "0 6px", whiteSpace: "nowrap" }, children: [
                "\u2442 ",
                b.name
              ] }, b.name)) }),
